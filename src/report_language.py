...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "plain_prev_label": "昨日",
        "plain_action_label": "现在",
        "plain_condition_label": "何时改变",
        "plain_risk_label": "最大风险",
        "plain_stop_loss_condition": "跌破 {stop_loss} 应止损离场",
    ...
    "en": {
        ...
        "plain_action_label": "Now",
        "plain_condition_label": "Trigger",
        "plain_risk_label": "Key risk",
        "plain_stop_loss_condition": "Exit if price breaks below {stop_loss}",
    ...
    "ko": {
        ...
        "plain_prev_label": "어제",
        "plain_action_label": "지금",
        "plain_condition_label": "변경 조건",
        "plain_risk_label": "핵심 리스크",
        "plain_stop_loss_condition": "{stop_loss} 이탈 시 손절",
